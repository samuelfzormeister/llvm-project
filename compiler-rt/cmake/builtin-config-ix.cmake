...
if(APPLE)
  ...
  find_darwin_sdk_dir(DARWIN_bridgeos_SYSROOT bridgeos)
  find_darwin_sdk_dir(DARWIN_driverkit_SYSROOT driverkit)
  ...
  if(COMPILER_RT_ENABLE_BRIDGEOS)
    list(APPEND DARWIN_EMBEDDED_PLATFORMS bridgeos)
    set(DARWIN_bridgeos_MIN_VER_FLAG -mbridgeos-version-min)
    set(DARWIN_bridgeos_BUILTIN_MIN_VER 2.0)
    set(DARWIN_bridgeos_BUILTIN_MIN_VER_FLAG
      ${DARWIN_bridgeos_MIN_VER_FLAG}=${DARWIN_bridgeos_BUILTIN_MIN_VER})
    set(DARWIN_bridgeos_BUILTIN_ALL_POSSIBLE_ARCHS arm64)
  endif()
  ...
  if(COMPILER_RT_ENABLE_DRIVERKIT)
    if(DARWIN_driverkit_SYSROOT)
      ...
      foreach(arch ${DARWIN_driverkit_BUILTIN_ARCHS})
        list(APPEND COMPILER_RT_SUPPORTED_ARCH ${arch})
        set(CAN_TARGET_${arch} 1)
      endforeach()
    endif()
